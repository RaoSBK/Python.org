...
#     """Returning full name formated"""
#     full_name = f"{first_name} {last_name}"
#     return full_name.title()

# while True:
#     print("Please tell me your full name")
#     print("Enter 'q' to quit from the program")
...
#         formatted_name = get_formated(f_name, l_name)
#         print(f"Hello {formatted_name}")



# Q 8-6. City Names: Write a function called city_country() that takes in the name 
...
print(city_country("Banglore", "india"))


# Q  08-7. Album: Write a function called make_album() that builds a dictionary 
...
album1 = make_album("Ed sheerean", "Divide")
...
album4 = make_album("coldplay", "parachutes", songs=10)
print(album4)


# Q 8-8. User Albums: Start with your program from Exercise 8-7. Write a while 
